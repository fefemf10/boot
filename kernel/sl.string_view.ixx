...
export namespace std
{
	...
	[[nodiscard]] constexpr bool operator==(const basic_string_view<T, Traits> left, const basic_string_view<T, Traits> right) noexcept {
	...
	inline u8string_view operator"" _sv(const char8_t* str, std::size_t len) noexcept
	{
		return u8string_view(str, len);
	}
	inline u16string_view operator"" _sv(const char16_t* str, std::size_t len) noexcept
	{
		return u16string_view(str, len);
	}
	inline u32string_view operator"" _sv(const char32_t* str, std::size_t len) noexcept
	{
