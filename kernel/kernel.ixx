...
[[noreturn]] void mainCRTStartup(const BootInfo& bootInfo)
{
	...
	//PITInterrupt.deliveryMode = (u64)APIC::IOAPIC::DeliveryMode::EDGE;
	//PITInterrupt.destinationMode = (u64)APIC::IOAPIC::DesctinationMode::PHYSICAL;
	//PITInterrupt.pinPolarity = 0;
	//PITInterrupt.destination = 0;
	//PITInterrupt.mask = 0;
	//APIC::ioapics[0].setRedirectionEntry(4, PITInterrupt);
