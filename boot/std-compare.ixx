...
export namespace std
{
    ...
    struct partial_ordering {
        ...
        [[nodiscard]] friend constexpr bool operator==(const partial_ordering value, nullptr_t) noexcept {
        ...
        [[nodiscard]] friend constexpr bool operator<(const partial_ordering value, nullptr_t) noexcept {
            return value._Value == static_cast<_Compare_t>(_Compare_ord::less);
        }
        ...
        [[nodiscard]] friend constexpr bool operator<=(const partial_ordering value, nullptr_t) noexcept {
            ...
            return static_cast<signed char>(0 - static_cast<unsigned int>(value._Value)) >= 0;
        }
        ...
        [[nodiscard]] friend constexpr bool operator<(nullptr_t, const partial_ordering value) noexcept {
            return value > 0;
        }
        ...
        [[nodiscard]] friend constexpr partial_ordering operator<=>(const partial_ordering value, nullptr_t) noexcept {
            return value;
        }

        [[nodiscard]] friend constexpr partial_ordering operator<=>(nullptr_t, const partial_ordering value) noexcept {
            // The stored value is either less (0xff), equivalent (0x00), greater (0x01), or unordered (0x80).
            ...
            return { static_cast<_Compare_t>(0 - static_cast<unsigned int>(value._Value)) };
        }
    ...
    struct weak_ordering {
        ...
        [[nodiscard]] friend constexpr bool operator==(const weak_ordering value, nullptr_t) noexcept {
            return value._Value == 0;
        }
        ...
        [[nodiscard]] friend constexpr bool operator<(nullptr_t, const weak_ordering value) noexcept {
            return value > 0;
        }
        ...
        [[nodiscard]] friend constexpr weak_ordering operator<=>(const weak_ordering value, nullptr_t) noexcept {
            return value;
        }

        [[nodiscard]] friend constexpr weak_ordering operator<=>(nullptr_t, const weak_ordering value) noexcept {
            return { static_cast<_Compare_t>(-value._Value) };
        }
    ...
    struct strong_ordering {
        ...
        [[nodiscard]] friend constexpr bool operator==(const strong_ordering value, nullptr_t) noexcept {
            return value._Value == 0;
        }
        ...
        [[nodiscard]] friend constexpr bool operator<(nullptr_t, const strong_ordering value) noexcept {
            return value > 0;
        }
        ...
        [[nodiscard]] friend constexpr strong_ordering operator<=>(const strong_ordering value, nullptr_t) noexcept {
            return value;
        }

        [[nodiscard]] friend constexpr strong_ordering operator<=>(nullptr_t, const strong_ordering value) noexcept {
            return { static_cast<_Compare_t>(-value._Value) };
        }
    ...
    using compare_three_way_result_t =
        decltype(declval<const remove_reference_t<_Ty1>&>() <=> declval<const remove_reference_t<_Ty2>&>());
    ...
    template <class _Ty1, class _Ty2 = _Ty1>
    using _Synth_three_way_result = decltype(_Synth_three_way{}(declval<_Ty1&>(), declval<_Ty2&>()));
            ...
            [[nodiscard]] static consteval _Choice_t<_St> _Choose() noexcept {
                if constexpr (!same_as<decay_t<_Ty1>, decay_t<_Ty2>>) {
                    ...
                    return { _St::_Adl, noexcept(static_cast<strong_ordering>(
                        /* ADL */ strong_order(declval<_Ty1&>(), declval<_Ty2&>()))) };
                }
                    ...
                    return { _St::_Three, noexcept(static_cast<strong_ordering>(
                                             compare_three_way{}(declval<_Ty1&>(), declval<_Ty2&>()))) };
                }
                else {
                    return { _St::_None };
                }
            ...
            [[nodiscard]] static consteval _Choice_t<_St> _Choose() noexcept {
                if constexpr (!same_as<decay_t<_Ty1>, decay_t<_Ty2>>) {
                    ...
                    return { _St::_Adl, noexcept(static_cast<weak_ordering>(
                        /* ADL */ weak_order(declval<_Ty1&>(), declval<_Ty2&>()))) };
                }
                else if constexpr (floating_point<decay_t<_Ty1>>) {
                    return { _St::_Floating, true };
                }
            ...
            [[nodiscard]] static consteval _Choice_t<_St> _Choose() noexcept {
                if constexpr (!same_as<decay_t<_Ty1>, decay_t<_Ty2>>) {
                    ...
                    return { _St::_Adl, noexcept(static_cast<partial_ordering>(
                        /* ADL */ partial_order(declval<_Ty1&>(), declval<_Ty2&>()))) };
                }
                else if constexpr (_Can_compare_three_way<_Ty1, _Ty2>) {
                    ...
                    return { _St::_Weak,
                        noexcept(static_cast<partial_ordering>(static_cast<weak_ordering>(
                            /* ADL, throughput optimization */ weak_order(declval<_Ty1&>(), declval<_Ty2&>())))) };
                }
                else if constexpr (_Strong_order::_Has_ADL<_Ty1, _Ty2>) {
        ...
        private:
            ...
            [[nodiscard]] static consteval _Choice_t<_St> _Choose() noexcept {
                if constexpr (!same_as<decay_t<_Ty1>, decay_t<_Ty2>>) {
                    ...
                    return { _St::_Strong, noexcept(strong_order(declval<_Ty1&>(), declval<_Ty2&>())) };
                }
                else if constexpr (_Can_fallback_eq_lt<_Ty1, _Ty2>) {
                    return { _St::_Fallback,
                        noexcept(declval<_Ty1&>() == declval<_Ty2&>() ? strong_ordering::equal
                                 : declval<_Ty1&>() < declval<_Ty2&>() ? strong_ordering::less
        ...
        private:
            ...
            [[nodiscard]] static consteval _Choice_t<_St> _Choose() noexcept {
                if constexpr (!same_as<decay_t<_Ty1>, decay_t<_Ty2>>) {
                    ...
                    return { _St::_Weak, noexcept(weak_order(declval<_Ty1&>(), declval<_Ty2&>())) };
                }
                else if constexpr (_Can_fallback_eq_lt<_Ty1, _Ty2>) {
                    return {
                        _St::_Fallback, noexcept(declval<_Ty1&>() == declval<_Ty2&>() ? weak_ordering::equivalent
                                                 : declval<_Ty1&>() < declval<_Ty2&>() ? weak_ordering::less
        ...
        private:
            ...
            [[nodiscard]] static consteval _Choice_t<_St> _Choose() noexcept {
                if constexpr (!same_as<decay_t<_Ty1>, decay_t<_Ty2>>) {
                    ...
                    return { _St::_Partial, noexcept(partial_order(declval<_Ty1&>(), declval<_Ty2&>())) };
                }
                else if constexpr (_Can_fallback_eq_lt_twice<_Ty1, _Ty2>) {
                    return { _St::_Fallback,
                        noexcept(declval<_Ty1&>() == declval<_Ty2&>() ? partial_ordering::equivalent
                                 : declval<_Ty1&>() < declval<_Ty2&>() ? partial_ordering::less
                                 : declval<_Ty2&>() < declval<_Ty1&>() ? partial_ordering::greater
